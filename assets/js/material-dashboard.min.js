...
function (e) {
  ...
  e(window).on("load", function () {
      $("").hide();
      e(".loader-inner").fadeOut(), e(".loader").delay(20).fadeOut("slow")
      
  }), e(window).on("scroll", function(){
      if($(window).scrollTop() > 180){
          $(".header").addClass("header-collaps");
          $(".main-nav li a").css({ 'color': '#333', 'font-weight': '600' });
          $(".main-nav li a.but").css({ 'color': '#FFF', 'font-weight': '400'});
          $(".logo-1").hide();
          $(".logo-2").show();
      } else {
          // if($(".toggle-mobile-but").toggleClass("active")==true){
              // $(".header").addClass("header-collaps");
              // $(".main-nav li a").css({ 'color': '#333', 'font-weight': '600' });
              // $(".logo-1").hide();
              // $(".logo-2").show();
          //     alert("1");
          // }else{
              $(".header").removeClass("header-collaps");
              $(".main-nav li a").css({ 'color': '#FFF', 'font-weight': '400'  });
              $(".logo-1").show();
              $(".logo-2").hide();
          //     alert("2");
          // }
  ...
  e(l).on("click", function () {
      if($(window).scrollTop() < 180 && $(".toggle-mobile-but").hasClass("active")==true){
          $(".header").removeClass("header-collaps");
          $(".main-nav li a").css({ 'color': '#FFF', 'font-weight': '400'  });
          $(".logo-1").show();
          $(".logo-2").hide();
  ...
  }), e(".countdown").countdown("2021/11/27", function (l) {
